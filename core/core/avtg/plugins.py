...
class Plugin(core.components.Component):
    def run(self):
        ...
        with open(in_abstract_task_desc_file, encoding='ascii') as fp:
        ...
        with open(out_abstract_task_desc_file, 'w', encoding='ascii') as fp:
            json.dump(self.abstract_task_desc, fp, sort_keys=True, indent=4)
