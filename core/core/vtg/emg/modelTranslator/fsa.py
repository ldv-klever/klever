...
class Automaton:
    ...
    def variables(self, only_used=False):
        ...
        lables except specific variables generated by a modelTranslator implementation not for particular lables.
    ...
    def determine_variable(self, label, shadow_use=False):
        ...
        :param shadow_use: Mark that variable is in use in process automaton.
