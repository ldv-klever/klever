...
urlpatterns = [
    ...
    path('safe/<int:mark_id>/edit/inl/', views.InlineEditForm.as_view(mtype='safe'), name="safe-edit-inl"),
    path('safe/<int:r_id>/create/inl/', views.InlineCreateForm.as_view(mtype='safe'), name="safe-create-inl"),
    ...
    path('unsafe/<int:mark_id>/edit/inl/', views.InlineEditForm.as_view(mtype='unsafe'), name="unsafe-edit-inl"),
    path('unsafe/<int:r_id>/create/inl/', views.InlineCreateForm.as_view(mtype='unsafe'), name="unsafe-create-inl"),
    ...
    path('unknown/<int:mark_id>/edit/inl/', views.InlineEditForm.as_view(mtype='unknown'), name="unknown-edit-inl"),
    path('unknown/<int:r_id>/create/inl/', views.InlineCreateForm.as_view(mtype='unknown'), name="unknown-create-inl"),
