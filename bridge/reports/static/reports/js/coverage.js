$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.error) {
                    ...
                    $('#CoverageSRCContent').html(data['content']).scrollTop(0);
                    $('#CoverageDataContent').html(data['data']).find('.item').tab();
                }
            }
        });
    }
    ...
    var src_code_content = $("#CoverageSRCContent"), src_data_content = $('#CoverageDataContent');
    ...
    src_code_content.on("click", ".COVLineLink", function(event) {
        ...
        var line_container = $(this).closest('.COVLine'), line_num = line_container.data('line');
        if (line_num) {
