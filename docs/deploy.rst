...
* If one is going to develop Klever (see :ref:`dev_deploy` in addition), one should
  install Klever Python package in *editable* mode (with -e flag). To do it, run the
  following command within :term:`$KLEVER_SRC`::
