...
It is also possible to deploy it on `Ubuntu 18.04 <https://wiki.ubuntu.com/BionicBeaver/ReleaseNotes>`__ and
`Fedora 32 <https://docs.fedoraproject.org/en-US/fedora/f32/>`__. You could also try other versions of Debian
and Fedora, or their various derivatives.

.. note:: Currently deployment on Fedora makes httpd_t SELinux domain permissive, which may
  negatively impact the security of your system. Deployment on Debian doesn't have this issue.
