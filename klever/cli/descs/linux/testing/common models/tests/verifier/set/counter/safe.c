...
static int __init ldv_init(void)
{
	...
	/*
	 * Ignoring elements and using counter as sets model allow to safely
	 * represent sets of multiple elements. However, if this isn't forbidden
	 * additionally this model can remove unexisting elements from empty sets.
	 * Besides, it doesn't distinguish different set elements.
	 */
	ldv_set_init(set);
